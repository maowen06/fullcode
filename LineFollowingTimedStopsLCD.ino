...
float dist420 = ((leftPulses + rightPulses) / 2.0) * CM_PER_PULSE;

if (!paused420 && dist420 >= 420.0) {
  ...
  if (leftBlack && rightBlack) {
    ...
    // If both see black for > 50ms, it's the finish line
...
float liveDist = ((leftPulses + rightPulses) / 2.0) * CM_PER_PULSE;
